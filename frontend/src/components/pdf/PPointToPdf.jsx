  ...
  const handleFileChange = (e) => {
    ...
    if (selectedFile) {
      ...
      if (validTypes.includes(selectedFile.type)) {
        ...
        setStatus('error');
        setMessage('Please select a valid PowerPoint file (.ppt or .pptx)');
        setFile(null);
      }
    }
  };
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-red-50 to-orange-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-2 text-center">PowerPoint to PDF</h1>
        <p className="text-center text-gray-600 mb-8">Convert your presentations to PDF</p>

        {/* File Upload Area */}
        <div className="mb-6">
          <label className="block mb-3">
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center cursor-pointer hover:border-blue-500 hover:bg-red-50 transition">
              <Upload className="w-12 h-12 text-gray-400 mx-auto mb-2" />
              <p className="text-gray-600 font-medium">Choose a PowerPoint file</p>
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-lg text-sm text-gray-600">
          ...
          <ul className="space-y-1 text-xs">
            ...
            <li>• Preserves animations & transitions</li>
            <li>• High quality output</li>
            <li>• One slide per page</li>
          </ul>
        </div>
